        ...
        <div className="w-screen h-screen flex flex-col items-center justify-center gap-5">
            <div className="max-w-96 w-full rounded-lg shadow-xl">
                ...
                <div className="flex flex-col gap-3 items-center p-5">
                    ...
                    <motion.button  whileTap={{scale: 0.9}} whileHover={{scale: 1.05}} className="px-5 py-2 bg-primary rounded-lg w-full my-3 font-bold">Continue with Google</motion.button>
                    ...
                    <p className="text-[12px] font-medium text-gray-400 outline-0">
